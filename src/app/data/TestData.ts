...
export class TestData {
  ...
  static tasks: Task[] = [
    ...
    {
      id: 7,
      title: "Найти билеты в Сингапур, выбрать отель",
      priority: TestData.priorities[2],
      completed: false,
    ...
    {
      id: 8,
      title: "Приготовить ужин для всей семьи (индейка с картошкой)",
      completed: false,
      category: TestData.categories[5]
    },
    {
      id: 9,
      title: "Подтянуться 6 раз",
      priority: TestData.priorities[2],
      completed: false,
    ...
    {
      id: 15,
      title: "Сдать экзамен по Javascript",
      priority: TestData.priorities[2],
      completed: true
    },
    ...
    {
      id: 17,
      title: "Написать завление на смену распорядка на работе",
      priority: TestData.priorities[2],
      completed: false,
      category: TestData.categories[6]
    },
